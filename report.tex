...
La variable \emph{children} qui nous permet d'avoir des encapsulations d'objets \emph{DocumentSymol}.

Un noeud doit être représenté par un \emph{Symbolkind} % https://vshaxe.github.io/vscode-extern/vscode/SymbolKind.html
