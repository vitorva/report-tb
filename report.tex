...
On aurait pu penser naivement que le mécanisme avancé de récupération d'erreur \emph{Parser Error Recovery Strategy} permettrait également de rendre le mécanisme de la complétion aussi plus tolérant.
