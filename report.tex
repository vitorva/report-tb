...
On appel généralement cettre stucure étant le "document outlining" ou "code outlining".

Les éléments peuvent être représentés de manière hiérarchique ou seulement être listés.

Un élément de l'outline (noeud) représente un élément unique du texte ou une structure.

On a accès à cette arbre sur l'espace adéquant...

%TODO : picture

ou depuis la barre de recherche
