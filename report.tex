...
La spécification se trouve sur :
...
\begin{figure}[!h]
    \begin{center}
        \frame{\includegraphics[width=5cm]{assets/figures/quickfix.PNG}}
    \end{center}
...
Pour toute ces raisons, travailler sur ce projet s'est révélé être très intéressant.
...
Plus globalement, implémenter des fonctionnalités s'est averé plus complexe que ce que je pensais. Car on est sens cesse confronté à des cas que l'on aurait pas penser et il est difficle de tout prévoir.
Il est aussi difficile de savoir quelle comportement est acceptable ou non et quand il faudrait s'arrêter.
