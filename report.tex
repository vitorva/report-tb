...
\chapter*{VsCode API (Direct implementation)}
Contrairement à l’approche d’un langage serveur, on peut communiquer directement avec l’api en s’inscrivant à des providers.
The editor will make requests to the providers when semantic tokens are needed
