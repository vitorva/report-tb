...
Il s'agira ici d'un token qui a posé problème et l'on voudra afficher à son emplacement l'indication visuelle (soulignement ondulé rouge) ainsi que le message d'erreur associé.

Le message d'erreur peut-être récupéré de la proprété \emph{msg}. Même s'il est davantage destiné au debuggage. Les messages d'erreurs sont générament assez
bon et peuvent être utilisé pour être afficher à l'utilisateur lorsqu'il passe sa souris sur l'erreur.
