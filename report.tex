...
\subsection{Types}
Une caractéristique importante de en UON est que tout type d'information appartient à un type. Les types sont organisés en différentes catégories.
Ces catégories sont illustrées par la figure \ref{type-base}.

\begin{figure}[!h]
    \begin{center}
        \frame{\includegraphics[width=10cm]{assets/figures/type-base.png}}
    \end{center}
