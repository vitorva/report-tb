...
Le code source de VS Code de Microsoft est open source (sous licence MIT) mais... % TODO
...
Car cette arbre contient des informations concernant la structure du document utiles pour certaines fonctionnalités.
...
Commme le squelette de base de l'extension à été créé en utilisant le générateur Yeoman, la structure pour écrire nos tests d'intégrations
existe déjà.
% citation
...
Actuellement on test de cette facon les fonctionnalités de la complétion et de l'outline.
...
Tous les fonctionnalités ne sont pas tester.

tous ces tests se trouvent dans le dossier test.
...
% TODO : Créer les construction à la main et comparer leur sorti textuelles
...
% https://github.com/tunnelvisionlabs/antlr4ts/issues/305
