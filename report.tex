...
Ce procédé nous permet de profiter des thèmes de VS Code implémenté par défaut dans l'éditeur, par exemple dans les exemples illustrés par les figures \ref{vscode-dark-theme} et \ref{vscode-kimbi-dark-theme}.
