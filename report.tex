...
Ajouter la gestion des propriétés s'est aussi révélé difficile.
...
C'est également depuis longtemps le premier "gros" projet que j'ai été ammené à réaliser seul.
...
L'éditeur affiche un caractère erroné (ondulation rouge) au début du document lorsque le fichier est vide. Cela vient aussi de la gestion des indentations.
