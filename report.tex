...
ANTLR est composé de deux parties principales. Il y a l'outil en java qui permet de générer le lexer et le parseur, donc le code permettant de reconnaitre un langage comme mentionné dans la section \ref{parsing}.
...
Les proprités en UON sont décrit dans la section \ref{properties}.
