...
L'analyse syntaxique consiste à regarder quelles sont les règles qui sont applicables pour une suite de tokens définie dans une grammaire. Un grammaire étant habituellement un fichier qui décrit formellement le langage.
...
UON est par nature proche du format JSON. Mais UON étant "YAML compliant" à un certain degré (reduced set), il est naturel de penser qu'un format YAML soit supporté même recommandé que son alternative.
...
N'importe quelle caractère peut se trouver entre guillement sauf un autre guillement et pareillement pour les apostrophe.
