...
C'est ce qui est recommandé dans la documentation du projet c3 de ne pas ignorer les espaces. Car cela permet de gérer plus de cas particuliers \cite{c3-example-soql}.
% https://neuroning.com/post/implementing-code-completion-for-vscode-with-antlr/

Même si l'on n'en profite pas actuellement, cela ne modifie pas le code en soit et cela permet l'extensibilité du code. % TODO : à vérifier
