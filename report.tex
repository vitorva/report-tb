...
C'est pourquoi on en extrait car un AST.
...
\begin{figure}[!h]
    \begin{center}
        \frame{\includegraphics[width=6cm]{assets/figures/parse-tree.PNG}}
    \end{center}
...
\begin{figure}[!h]
    \begin{center}
        \frame{\includegraphics[width=3cm]{assets/figures/lint.PNG}}
    \end{center}
...
\begin{figure}[!h]
    \begin{center}
        \frame{\includegraphics[width=3cm]{assets/figures/quickfix.PNG}}
    \end{center}
    \caption[Quick fix]{\label{quick-fix} Quick fix}
\end{figure}
