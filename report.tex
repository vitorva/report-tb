...
L'Extension API nous permet, par exemple de faire du theming, étendre le Workbench, Webview, Extension de langage, Extendion pour debugger)
On se focalisera sur le theming et l'extension de language.
