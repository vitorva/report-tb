...
Parmis ces trois, la validation pourrait être pertinente mais ne fait pas parti du CDC même si possible.
...
Cependant il ne s'agit que d'une infime parti de ce qui peut être réalisable.

On pourrait aussi mentionner la validation par un schéma, la prise en compte des commentaires...??

Nous pouvons catégoriser les fonctionnalités de la manière suivante :
...
\chapter{Parsing}
Le travail ne porte pas sur cette élément en particulier.
Mais il est important de rappeler des concepts

\textbf{TODO}
\section{Lexical analysis}
\section{Sytactic analysis}
\section{Final stages of parsing}
\chapter{Generator de parsing}

\textbf{TODO}
\chapter{Format de sérialisation}
Rôle d'un format de sérialsation....
\section{JSON}
\section{YAML}
\section{Protobuf}
