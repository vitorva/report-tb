...
\begin{itemize}
    ...
    \item Implémenter de l'autocomplétion : les éléments proposés à l'utilisateur sont des mots-clés (le nom des structures, des unités et les types et leurs propriétés associées).
